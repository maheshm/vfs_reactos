/*
	/include/vfs.h - general reactos file system structures definition
	some structures are inspired from existing ext2 file system implementations for windows.
*/
